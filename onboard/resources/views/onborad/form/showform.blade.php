...
<div class="container client-info" style="width:210mm; min-height:297mm; padding:20mm; margin:auto; background:#fff; box-shadow:0 0 5px rgba(0,0,0,0.1);">
    ...
    <div style="text-align:right; margin-bottom:20px;">
        ...
        <a href="{{ route('client.show', $client->id ?? 0) }}" target="_blank" onclick="setTimeout(()=>window.print(),500); return false;" style="padding:8px 16px; background-color:#38c172; color:#fff; text-decoration:none; border-radius:5px;">⬇ Download PDF</a>
    </div>
...
<style>
body { font-family:'SolaimanLipi',sans-serif; background:#f5f5f5; color:#333; }
h1 { font-weight:700; }
h3 { margin-top:25px; margin-bottom:10px; font-weight:700; border-bottom:1px solid #ccc; padding-bottom:5px; }
p { margin:4px 0; font-weight:400; word-wrap:break-word; overflow-wrap:break-word; white-space:pre-wrap; }
strong { font-weight:600; }
@media print { body { background:#fff; } .container { box-shadow:none; width:100%; min-height:auto; padding:0; margin:0; } button,a { display:none; } }
</style>
